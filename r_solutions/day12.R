...
for (i in seq_along(1:10)) {
  ...
  glue::glue("-----Iteration: {i}-------")
  glue::glue("<x={p0[[1]][[1]][[1]]}, y={p0[[1]][[1]][[2]]}, z={p0[[1]][[1]][[3]]}>, vel=<x={p0[[1]][[2]][[1]]}, y={p0[[1]][[2]][[2]]}, z={p0[[1]][[2]][[3]]}>\n
...
sum(abs(pluck(p0,1,1))) * sum(abs(pluck(p0,1,2))) +
  sum(abs(pluck(p0,2,1))) * sum(abs(pluck(p0,2,2))) +
  sum(abs(pluck(p0,3,1))) * sum(abs(pluck(p0,3,2))) +
  sum(abs(pluck(p0,4,1))) * sum(abs(pluck(p0,4,2)))
